...
#### 2.1 yarn 和 npm 支持 workspace，但不支持在 package.json 中使用 workspace 协议写法

声明依赖版本时，需要写具体的版本号，不能写 workspace 协议语法

**错误示例**
```bash
yarn add @demo/common@workspace:[*|^|^1.0.0] -w @demo/app

npm install @demo/common@workspace:[*|^|^1.0.0] -w @demo/app

```
```json
"dependencies": {
  "@demo/common": "workspace:^"
}
...
"dependencies": {
  "@demo/common": "workspace:^1.0.0"
}
```

**正确示例**
```bash
yarn add @demo/common -w @demo/app

npm install @demo/common -w @demo/app
